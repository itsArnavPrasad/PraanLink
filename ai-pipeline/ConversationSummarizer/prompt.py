...
Instructions:
1. Extract and summarize symptoms, medications taken, mood, energy level, sleep quality, and main concerns.
2. Capture only clinically or contextually relevant details.
3. Maintain a neutral, factual tone suitable for medical records.

Example output:
{
  "summary_notes": "Patient reports fatigue and mild headache for 3 days. Taking Paracetamol 500mg as needed. No other medications.",
  "mood": "Neutral",
